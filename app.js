...
// Endpoint para listar os comentários de uma postagem por ordem decrescente de data
app.get(`${PATH_ID}/comentarios`, (req, res) => {
    ...
    // Ordena os comentários por data decrescente
    const comentariosOrdenados = comentarios.sort((a, b) => new Date(b.getData()) - new Date(a.getData()));

    res.status(200).json(comentariosOrdenados);
});
